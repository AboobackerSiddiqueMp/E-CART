...
function Footer() {
  return (
    <div style={{marginTop:'30px'}} className='bg-primary m-0'>
      <div className='d-flex justify-content-center alig-items-center '>
        <div className="footer d-flex justify-content-evenly alig-items-center mt-5 p-0 mb-0 " >
          <div className="website " style={{ width: '400px' }}>
            <h5><i class="fa-solid fa-cart-shopping "  ></i>E-CART</h5>
          ...
          <div className="links d-flex flex-column ms-5">
            <div className="links d-flex flex-column ms-5">
              ...
              <Link to='/Home' style={{ textDecoration: 'none', color: 'black' }}>Cart</Link>
              <Link to='/Watchhistoty' style={{ textDecoration: 'none', color: 'black' }}>wishList</Link>
            </div>
